...
const frontendCoveragePath = path.join(__dirname, '../apps/frontend/coverage/coverage-summary.json')
...
const contractsCoveragePath = path.join(__dirname, '../packages/contracts/coverage/coverage-summary.json')
