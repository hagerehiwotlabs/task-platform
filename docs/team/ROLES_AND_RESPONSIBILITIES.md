...
This document defines the roles, responsibilities, and expectations for all team members. Clear role definitions enable effective collaboration, accountability, and career growth.

## ⚡ TL;DR

- This document clarifies **who does what**, **who decides**, and **how people grow**.
- Leads own direction, standards, and team health.
- Developers own delivery, quality, and collaboration.
- Expectations increase with seniority and scope.
- Career progression is transparent, structured, and merit-based.
...
- Represent team to stakeholders and clients
...
- Facilitate frontend knowledge sharing
...
- Coordinate with backend and design teams
...
- Frontend tooling and libraries
...
- Facilitate backend knowledge sharing
...
- Backend hiring recommendations
...
- Ensure fast build and test times
...
4. **Metrics review**: Quantitative performance data
